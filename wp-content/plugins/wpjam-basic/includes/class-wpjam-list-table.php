...
class WPJAM_List_Table extends WP_List_Table{
	...
	public function is_available($object){
		...
		if($object->post_type && $object->data_type != 'post_type' && ($this->data_type != 'post_type' || !in_array($this->post_type, (array)$object->post_type))){
			return false;
		}
		
		if($object->taxonomy && $object->data_type != 'taxonomy' && ($this->data_type != 'taxonomy' || !in_array($this->taxonomy, (array)$object->taxonomy))){
			return false;
		}
